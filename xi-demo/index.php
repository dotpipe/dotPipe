<!doctype html>
<html lang="en" data-theme="dark" data-site-id="xi-xi-demo"><head>
  <meta charset="utf-8">
...
<body>
  <main class="demo-shell">
    ...
    <footer><span>Site scope: <code>xi-xi-demo</code></span><span>Rules: <code>.xi</code></span><a href="../dashboard/">Open XI XI Control Panel →</a></footer>
  </main>
  <script>
    (() => {
      const $ = id => document.getElementById(id); const PUBLISHED_KEY = 'xi-xi-demo.published-html'; let cycles = 0; let hoveredNest = null;
