...
This directory explains the repository as it exists in source. It is not generated from the older HTML documentation pages.
...
- `VALIDATION.md`: checks and known gaps.
- `LEGACY-DOCS.md`: status of the older visual HTML documentation pages.
