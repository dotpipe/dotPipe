...
async function installSystemd(args) {
  ...
  const servicePath = path.join(unitDirectory, 'xi-xi-audit.service');
  const timerPath = path.join(unitDirectory, 'xi-xi-audit.timer');
  ...
  runLocal('systemctl', ['--user', 'enable', '--now', 'xi-xi-audit.timer']);
...
async function uninstallSystemd() {
  ...
  const servicePath = path.join(unitDirectory, 'xi-xi-audit.service');
  const timerPath = path.join(unitDirectory, 'xi-xi-audit.timer');
  runLocal('systemctl', ['--user', 'disable', '--now', 'xi-xi-audit.timer']);
